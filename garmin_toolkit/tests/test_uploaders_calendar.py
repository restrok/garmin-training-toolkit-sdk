"""Tests for calendar management and cleanup logic."""
...
def test_clear_calendar_range_with_id_fallback() -> None:
    """Verifies clear_calendar_range handles both calendarItemId and id fallbacks."""
...
def test_clear_calendar_range_empty() -> None:
    """Verifies clear_calendar_range returns 0 when no items are found."""
    client = MockGarminClient()
    cleared_count = clear_calendar_range(client, "2026-05-01", "2026-05-31")
