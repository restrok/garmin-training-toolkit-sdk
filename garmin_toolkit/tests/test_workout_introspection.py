...
from garmin_training_toolkit_sdk.protocol.workouts import WorkoutTemplateSummary
...
class TestWorkoutIntrospection(unittest.TestCase):
    def setUp(self):
        ...
        with patch("garmin_training_toolkit_sdk.core.garmin.find_token_file") as mock_find:
            mock_find.return_value = "dummy_path"
            # Mock get_authenticated_client to return our MockGarminClient
            with patch("garmin_training_toolkit_sdk.core.garmin.get_authenticated_client") as mock_get_client:
                self.mock_client = MockGarminClient()
                mock_get_client.return_value = self.mock_client
                self.provider = GarminProvider()

    def test_get_workout_templates_mapping(self):
    ...
    def test_get_workout_templates_empty(self):
